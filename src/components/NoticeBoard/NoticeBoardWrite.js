    ...
    <>
      ...
      <div>
        ...
        <StyledForm className="ReviewForm" onSubmit={handleSubmit}>
          ...
          <div style={{ backgroundColor: '#dff1f9', borderRadius: '4px', padding: '10px', fontSize: '7px', color: 'gray' }}>
            <p>
              • 검수 과정에서 허위, 조작, 비방, 욕설, 무의미한 내용 등으로 작성된 글은 반려처리되며,
              검수 과정을 방해할 목적으로 판단되는 악의적인 작성자에 대해서는 사안에 따라 오늘학교 운영팀에서
              계정 정지 또는 영업방해, 명예훼손 등의 건으로 법적인 조치를 취할 수 있습니다.
            </p>
          </div>
        </StyledForm>
      </div>
