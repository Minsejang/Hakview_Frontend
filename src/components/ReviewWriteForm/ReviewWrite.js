      ...
      <div>
        ...
        <StyledForm className="ReviewForm" onSubmit={handleSubmit}>
          ...
          * 리뷰 제목
          ...
          <input type="text" name="tag1" style={{ display: 'none' }} value={tag1} onChange={handleInputChange} />
          <input type="text" name="tag2" style={{ display: 'none' }} value={tag2} onChange={handleInputChange} />
          <input type="text" name="tag3" style={{ display: 'none' }} value={tag3} onChange={handleInputChange} />
          <input type="text" name="serial" style={{ display: 'none' }} value={postId} onChange={handleInputChange} />
          <div>* 리뷰 작성 하기</div>
          <StyledDiv>
            <StyledTextarea
